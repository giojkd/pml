    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom boxless">
            ...
            <div class="portlet box blue ">
                ...
                <?php endif; ?>
                    <!-- BEGIN FORM-->
                    <form class="item_add_form" action="<?php echo site_url() ?>stock/external_item_edit_save" method="post">
                        <div class="form-body col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="item_quantity" value="<?php echo $details["current_quantity"]; ?>" class="form-control" required/>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Note</label>
                                <textarea name="note"class="form-control"><?php echo $details["note"]; ?></textarea>
                            </div>
