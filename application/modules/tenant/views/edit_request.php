        ...
        <div class="tabbable tabbable-custom boxless">
            ...
            <div class="portlet box blue ">
                ...
                <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <form class="tenant_add_request_form" action="<?php echo site_url() ?>tenant/edit_requestsave" method="post" >
                        <div class="form-body col-xs-12">
                            <div class="form-group">
                                <label class="control-label">Status</label>
                                <select name="request_for" id="request_for" class="form-control" required>
                                    <option value="1" <?php echo $request['request_for'] == "1" ?"selected":""; ?>>Maintenance</option>
                                    <option value="2" <?php echo $request['request_for'] == "2" ?"selected":""; ?>>Cleaning</option>
                                    <option value="3" <?php echo $request['request_for'] == "3" ?"selected":""; ?>>Other</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="tenant_id" class="form-control" id="tenant_id">
                                    ...
                                    <?php foreach ($tenants as $key => $value) { ?>
                                        <option value="<?php echo $value['id']; ?>" <?php echo $value['id'] == $request['user_id'] ? 'selected' : ''; ?>><?php echo $value['name'] . ' ' . $value['family_name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control" required>
                                    <option value="0" <?php if($request['status']=="0") echo "selected"; ?>>Open</option>
                                    <option value="1" <?php if($request['status']=="1") echo "selected"; ?>>Closed</option>
                                </select>
                            </div>
