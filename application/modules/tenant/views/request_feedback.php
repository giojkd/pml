...
<div class="row">
    <div class="col-md-12">
        <div class="tabbable tabbable-custom boxless">
            <!--Gallery Start -->
                    <?php if(!empty($all_request_images)){?>
                    <div class="btn-group margin-bottom-10 gallery-link">
            ...
            <div class="portlet box blue ">
                ...
                <div class="message-send-area">
                    <form class="message-send" action="<?php echo base_url_tr('tenant/send_message'); ?>">
...
<script>
    $(document).ready(function () {
        ...
        $(".portlet-chat-body").animate({scrollTop: $('.portlet-chat-body').prop("scrollHeight")}, 1000);
        ...
        window.setInterval(function () {
            $.ajax({
                url: '<?php echo base_url_tr('tenant/refresh_feedback'); ?>',
                type: 'POST',
        ...
        function make_all_feedback_seen() {
            $.ajax({
                url: '<?php echo base_url_tr('tenant/make_all_feedback_seen'); ?>',
                type: 'POST',
