<div class="panel panel-success">
    ...
    <div class="panel-body">
        <div class="btn-group margin-bottom-10">
            ...
            <span><a href="<?php echo base_url_tr() ?>reports/per_apartment_pdf?apartment_id=<?php echo $apartment_id ?>&from_month=<?php echo $from_month; ?>&to_month=<?php echo $to_month; ?>" class="btn purple"><i class="fa fa-file-pdf-o"></i> PDF</a></span>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-success">
                    <form method="get" action="<?php echo base_url_tr('reports/per_apartment'); ?>">
                        <div class="col-lg-3">
                            <div class="input">
        ...
        <table class="table table-striped table-bordered table-hover display responsive nowrap datatable" width="100%">
            ...
            <tbody>
               ...
               if($per_apartment_inout_cash && count($per_apartment_inout_cash) > 0) {
                   foreach ($per_apartment_inout_cash as $cash) {
                        ...
                        ?>
                        <tr>
                            <td><?php echo $cash->apartment_id; ?></td>
...
<script type="text/javascript">
    function costDetails(apartmentId){
        ...
        var total_amount=0;
        var total_revenue=0;
        $(".modal-title").html("Cost & Revenue Details Property ID-"+apartmentId);
        $.ajax({
