    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom boxless">
            ...
            <div class="portlet box blue ">
                ...
                <?php endif; ?>
                    <!-- BEGIN FORM-->
                    <form class="item_add_form" action="<?php echo site_url() ?>source/editSave/<?php echo $source['id'];?>" method="post">
                        <div class="form-body col-xs-12">
                            <div class="form-group">
                                <label class="control-label">Source Name</label>
                                <input type="text" name="source_name" value="<?php echo $source['source_name']; ?>" class="form-control" required/>
                            </div>
