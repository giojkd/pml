        ...
        <table class="table table-striped table-bordered table-hover display responsive nowrap" id="due_payment_lists" width="100%">
            <thead>
                <tr>
                    ...
                    <th>To be paid from</th>
                    <th>To be paid for</th>
            ...
            <tbody>
                <?php foreach ($payments as $value): ?>
                    <tr>
                        ...
                        <td><?php echo related_to($value["related_to"]); ?></td>
                        <td><?php echo service_charges($value["cost_type"]); ?></td>
                        <td><?php echo mydate($value["expired_date"],"-"); ?></td>
                        <td><?php echo $value["apartment_id"]=="0"?"All":$value["apartment_id"]." (".$value["address"].")"; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
