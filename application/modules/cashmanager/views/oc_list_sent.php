        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-success">
                    <form method="get" action="<?php echo base_url_tr('cashmanager/outgoing/oc_list_sent'); ?>">
                        <div class="col-lg-3">
                            <div class="input">
                        ...
                        <div class="col-lg-2">
                            <div class="input">
                                ...
                                <input type="text" value="<?php echo $from_month ? $from_month : null; ?>" name="from_month" placeholder="" class="form-control filter-date" />
                            </div><!-- /input-group -->
                        </div><!-- /.col-lg-6 -->
                        ...
                        <div class="col-lg-2">
                            <div class="input">
                                <label>To Date</label>
                                <input type="text" value="<?php echo $to_month ? $to_month : null; ?>" name="to_month" placeholder="" class="form-control filter-date" />
                            </div><!-- /input-group -->
                        </div><!-- /.col-lg-6 -->
