...
<html lang="en">
    ...
    <head>
        ...
        <!-- BEGIN THEME STYLES -->
        <link href="<?php echo site_url('admin_assets/pages/css/login.css'); ?>" rel="stylesheet" type="text/css"/>
        ...
        <link id="style_color" href="<?php echo site_url('admin_assets/layout/css/themes/darkblue.css'); ?>" rel="stylesheet" type="text/css"/>
    ...
    <body class="login">
        ...
        <div class="logo">
			<a href="index.html">
				<img src="<?php echo base_url('admin_assets/img/logo.png'); ?>" alt=""/>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url_tr('authentication/login_chk?redirectto=' . $this->input->get('redirectto')); ?>" method="post">
        ...
        <div class="copyright">
            <?php echo date("Y"); ?> © PML Services. Powered by MGC Group.</div>
        <!-- END LOGIN -->
        ...
        <script src="<?php echo site_url('admin_assets/pages/scripts/login.js'); ?>" type="text/javascript"></script>
