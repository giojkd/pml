    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom boxless">
            ...
            <div class="portlet box blue ">
                ...
                <?php endif; ?>
                    <!-- BEGIN FORM-->
                    <form class="item_add_form" action="<?php echo site_url() ?>settings/mobilepackage/add_save" method="post">
                        <div class="form-body col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile_company" class="form-control" required/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="plan_description" class="form-control" required/>
                            </div>

                            <div class="form-group">
                                <label class="control-label">Cost</label>
                                <input type="text" name="plan_cost" class="form-control" required/>
                            </div>
