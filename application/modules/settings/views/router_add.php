    ...
    <div class="col-md-12">
        <div class="tabbable tabbable-custom boxless">
            ...
            <div class="portlet box blue ">
                ...
                <?php endif; ?>
                    <!-- BEGIN FORM-->
                    <form class="item_add_form" action="<?php echo site_url() ?>settings/wifirouter/router_add_save" method="post">
                        <div class="form-body col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="router_location" class="form-control" required/>
                            </div>
                            
                            <div class="form-group">
                                <label class="control-label">Date</label>
                                <input type="text" name="insert_date" id="insert_date" class="form-control" required />
                            </div>
