                    ...
                    foreach ($users as $key => $value) {
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a title="Work Reference File" href="<?php echo site_url() ?>uploads/user_file/<?php echo $value['work_reference_file'] ?>" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-download-alt"></i></a>
                                <?php } ?>
                                
                                <?php if($value['education_program_file'] != "") { ?>
                                <a title="Education Program File" href="<?php echo base_url_tr() ?>uploads/user_file/<?php echo $value['education_program_file'] ?>" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-download-alt"></i></a>
                                <?php } ?>

                                <?php if($value['passport_file'] != "") { ?>
                                <a title="Passport File" href="<?php echo base_url_tr() ?>uploads/user_file/<?php echo $value['passport_file'] ?>" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-download-alt"></i></a>
                                <?php } ?>
                            </td>
                            <td>
